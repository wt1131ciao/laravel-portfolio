...
<div class="max-w-2xl">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-6">チケットを編集</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('admin.tickets.update', $ticket) }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $ticket->name) }}" required
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('description') border-red-400 @enderror">{{ old('description', $ticket->description) }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" id="price" name="price" value="{{ old('price', $ticket->price) }}" required min="1"
                ...
                <div>
                    ...
                    <input type="number" id="stock" name="stock" value="{{ old('stock', $ticket->stock) }}" required min="0"
            ...
            <div>
                ...
                <input type="url" id="image_url" name="image_url" value="{{ old('image_url', $ticket->image_url) }}"
